...
/* image/new.html.twig */
class __TwigTemplate_042e865a9fee80bba7c1e267edc7947c extends Template
{
...
<div class=\"m-portlet m-portlet--tab\">
    <form role=\"form\" class=\"m-form m-form--fit m-form--label-align-right\" name=\"image\" action=\"";
        // line 19
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("user_image_new", ["id" => (isset($context["id"]) || array_key_exists("id", $context) ? $context["id"] : (function () { throw new RuntimeError('Variable "id" does not exist.', 19, $this->source); })())]), "html", null, true);
    ...
    <table class=\"table\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["image"]) {
            ...
            // line 59
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("user_image_delete", ["id" => CoreExtension::getAttribute($this->env, $this->source, $context["image"], "id", [], "any", false, false, false, 59), "pid" => (isset($context["id"]) || array_key_exists("id", $context) ? $context["id"] : (function () { throw new RuntimeError('Variable "id" does not exist.', 59, $this->source); })())]), "html", null, true);
...
<!--begin::Form-->
<div class=\"m-portlet m-portlet--tab\">
    <form role=\"form\" class=\"m-form m-form--fit m-form--label-align-right\" name=\"image\" action=\"{{ path('user_image_new', {'id': id}) }}\" method=\"post\" enctype=\"multipart/form-data\">
        <div class=\"m-portlet__body\">
            <div class=\"form-group m-form__group row\">
                <label for=\"example-text-input\" class=\"col-2 col-form-label\">Title</label>
                <div class=\"col-10\">
...
", "image/new.html.twig", "/Applications/XAMPP/xamppfiles/htdocs/apps/muzeum/templates/image/new.html.twig");
    }
}

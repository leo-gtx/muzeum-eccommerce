...
class __TwigTemplate_6ddb027289e3f0c2bb44fce119818201 extends Template
{
                ...
                <div class=\"col-sm-12\">
                    <div class=\"blog-post-area\">
                        ...
                        <div class=\"single-blog-post\">
                            ";
        // line 30
        yield CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["setting"]) || array_key_exists("setting", $context) ? $context["setting"] : (function () { throw new RuntimeError('Variable "setting" does not exist.', 30, $this->source); })()), 0, [], "array", false, false, false, 30), "aboutus", [], "any", false, false, false, 30);
        yield "
                        </div>
                    </div>
                </div>
...
";
    ...
    {
        return array (  167 => 30,  150 => 16,  146 => 15,  137 => 8,  127 => 7,  107 => 5,  87 => 4,  66 => 3,  43 => 1,);
    }
...
\t\t\t\t\t\t<a href=\"{{path('home_about')}}\">A propos</a>
\t\t\t\t\t</nav>
\t\t\t\t</div>
\t\t\t</div>
\t\t</div>
...
{% endblock %}
", "home/aboutus.html.twig", "/Applications/XAMPP/xamppfiles/htdocs/apps/muzeum/templates/home/aboutus.html.twig");
    }
}

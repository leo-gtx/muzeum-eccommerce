...
class __TwigTemplate_03ba9654de7557a1232117e169b6bb45 extends Template
{
    ...
    ";
        ...
        yield "
    <button class=\"btn btn-primary m-btn--custom\">";
        // line 4
...
{{ form_start(form) }}
    {{ form_widget(form) }}
    <button class=\"btn btn-primary m-btn--custom\">{{ button_label|default('Save') }}</button>
{{ form_end(form) }}
", "admin/category/_form.html.twig", "/Applications/XAMPP/xamppfiles/htdocs/apps/muzeum/templates/admin/category/_form.html.twig");
    }
}

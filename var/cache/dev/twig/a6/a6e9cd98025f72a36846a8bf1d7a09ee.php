...
class __TwigTemplate_cbd734bb2a20a9ab85f4389d0adbfb1f extends Template
{
    ...
    public function block_liip_imagine_image_widget($context, array $blocks = [])
    {
        ...
        if ((isset($context["image_path"]) || array_key_exists("image_path", $context) ? $context["image_path"] : (function () { throw new RuntimeError('Variable "image_path" does not exist.', 2, $this->source); })())) {
            ...
            if ((isset($context["link_url"]) || array_key_exists("link_url", $context) ? $context["link_url"] : (function () { throw new RuntimeError('Variable "link_url" does not exist.', 4, $this->source); })())) {
                // line 5
                yield "                <a href=\"";
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((((isset($context["link_filter"]) || array_key_exists("link_filter", $context) ? $context["link_filter"] : (function () { throw new RuntimeError('Variable "link_filter" does not exist.', 5, $this->source); })())) ? ($this->extensions['Liip\ImagineBundle\Templating\FilterExtension']->filter((isset($context["link_url"]) || array_key_exists("link_url", $context) ? $context["link_url"] : (function () { throw new RuntimeError('Variable "link_url" does not exist.', 5, $this->source); })()), (isset($context["link_filter"]) || array_key_exists("link_filter", $context) ? $context["link_filter"] : (function () { throw new RuntimeError('Variable "link_filter" does not exist.', 5, $this->source); })()))) : ((isset($context["link_url"]) || array_key_exists("link_url", $context) ? $context["link_url"] : (function () { throw new RuntimeError('Variable "link_url" does not exist.', 5, $this->source); })()))), "html", null, true);
                yield "\" ";
...
";
    ...
    {
        return array (  128 => 16,  125 => 15,  121 => 13,  117 => 11,  115 => 10,  98 => 8,  95 => 7,  77 => 5,  75 => 4,  72 => 3,  69 => 2,  49 => 1,);
    }
...
{% endblock %}
", "@LiipImagine/Form/form_div_layout.html.twig", "/Applications/XAMPP/xamppfiles/htdocs/apps/muzeum/vendor/liip/imagine-bundle/Resources/views/Form/form_div_layout.html.twig");
    }
}
